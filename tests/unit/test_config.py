...
def test_market_analysis_is_disabled_by_default_without_openai_credentials() -> None:
    settings = Settings(environment="test", _env_file=None)
...
def test_enabled_market_analysis_requires_openai_configuration() -> None:
...
def test_openai_credential_can_be_staged_while_market_analysis_is_disabled() -> None:
    settings = Settings(
        environment="test",
        openai_api_key=_OPENAI_SECRET,
        _env_file=None,
